"""Regression checks for the vertex-dev-release-guard casebook."""
...
from casebook.harness import assert_expected, vertex_dev_release_guard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vertex_dev_release_guard_summary(), assert_expected())
